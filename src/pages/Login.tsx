...
import logoGoogle from "../assets/icons8-google-logo-48.png"
    ...
    <div className="w-full bg-orange-200 flex flex-col justify-center items-center rounded-3xl">
      <div className="grid grid-cols-2 w-full">
        <div className="flex flex-col justify-center items-center p-4">
          ...
          <Button className="border-2 rounded-2xl text-black border-white bg-orange-300 p-4 mt-4  py-5 w-full">
            ...
            <Input
              type="text"
              placeholder="E-mail"
              className="border-2 rounded-2xl border-white bg-orange-300 p-4 mt-4  py-5"
            />
            <Input
              type="password"
              placeholder="Senha"
              className="border-2 rounded-2xl border-white p-4 mt-4 bg-orange-300 py-5"
            />
